...
public class PriestToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "priest token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.priest");
		itemBuilder.name(name, name+"s", "A priest token. This can be consumed to bid towards the Abbot office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.CHANNELING, ItemList.hammerMetal, 22765,
