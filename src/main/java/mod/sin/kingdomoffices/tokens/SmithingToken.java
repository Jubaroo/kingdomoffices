...
public class SmithingToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "smithing token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.smithing");
		itemBuilder.name(name, name+"s", "A smithing token. This can be consumed to bid towards the Court Rustfriend office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.GROUP_SMITHING, ItemList.hammerMetal, 22765,
