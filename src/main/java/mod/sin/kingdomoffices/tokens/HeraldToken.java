...
public class HeraldToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "herald token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.herald");
		itemBuilder.name(name, name+"s", "A herald token. This can be consumed to bid towards the Royal Bragger office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.PAPYRUSMAKING, ItemList.hammerMetal, 22765,
