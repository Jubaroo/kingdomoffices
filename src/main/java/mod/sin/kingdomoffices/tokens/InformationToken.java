...
public class InformationToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "information token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.information");
		itemBuilder.name(name, name+"s", "An information token. This can be consumed to bid towards the Disinformation Minister office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.MIND_LOGICAL, ItemList.hammerMetal, 22765,
