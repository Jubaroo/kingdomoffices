...
public class EconomicToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "economic token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.economic");
		itemBuilder.name(name, name+"s", "A economic token. This can be consumed to bid towards the Economic Catastrophe office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.SMITHING_GOLDSMITHING, ItemList.hammerMetal, 22765,
