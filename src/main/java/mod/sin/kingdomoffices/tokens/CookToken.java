...
public class CookToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "cook token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.cook");
		itemBuilder.name(name, name+"s", "A cook token. This can be consumed to bid towards the Royal Poisoner office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.GROUP_COOKING, ItemList.hammerMetal, 22765,
