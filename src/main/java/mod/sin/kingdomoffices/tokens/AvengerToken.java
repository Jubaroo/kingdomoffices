...
public class AvengerToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "avenger token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.avenger");
		itemBuilder.name(name, name+"s", "An avenger token. This can be consumed to bid towards the Royal Bully office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.GROUP_FIGHTING, ItemList.hammerMetal, 22765,
