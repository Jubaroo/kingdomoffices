...
public class LoverToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "lover token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.lover");
		itemBuilder.name(name, name+"s", "A lover token. This can be consumed to bid towards the Royal Page office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.SOUL_STRENGTH, ItemList.hammerMetal, 22765,
