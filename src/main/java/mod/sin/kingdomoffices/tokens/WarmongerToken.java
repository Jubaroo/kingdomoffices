...
public class WarmongerToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "warmonger token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.marshal");
		itemBuilder.name(name, name+"s", "A warmonger token. This can be consumed to bid towards the Earl Warmonger office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.FIGHT_AGGRESSIVESTYLE, ItemList.hammerMetal, 22765,
