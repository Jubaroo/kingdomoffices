...
public class MageToken extends ItemModTemplate implements ItemTypes, MiscConstants {
	private String name = "mage token";
	public void createTemplate() throws IOException{
		ItemTemplateBuilder itemBuilder = new ItemTemplateBuilder("mod.item.token.mage");
		itemBuilder.name(name, name+"s", "A mage token. This can be consumed to bid towards the Court Trixter office.");
	...
	public void initCreationEntry(){
		...
		if(templateId > 0){
			...
			CreationEntryCreator.createSimpleEntry(SkillList.GROUP_RELIGION, ItemList.hammerMetal, 22765,
